...
public class MainTest {
    ...
    public void speed() {
        ...
        System.out.println("最佳情况耗时-" + (System.currentTimeMillis() - startTime) + "ms");
        startTime = System.currentTimeMillis();
        for (int i = 0; i < 10000; i++) {
            RegionMatcher.byDetail("", "西城镇", "");
        }
        System.out.println("最差情况耗时-" + (System.currentTimeMillis() - startTime) + "ms");
    }
    ...
    public void test3() {
        RegionMatcher.init();
        RegionMatcher.setMatchUnavailable(false);
